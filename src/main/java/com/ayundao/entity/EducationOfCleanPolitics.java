 ...
 */
@Entity
@Table(name = "t_educationofcleanpolitics")
public class EducationOfCleanPolitics extends BaseEntity<String> {

    private static final long serialVersionUID = -1172084710974098504L;
